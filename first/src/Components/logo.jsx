...
const Logo = () => {
  return (
    <div className='flex justify-center align-middle  w-fit h-full'>
     <div className='text-blue-500 flex justify-center items-center'>
        <svg xmlns="http://www.w3.org/2000/svg" id="search-chat" width="24" height="22" style={{ fill: '#0E3566' }}>
      ...
      <div
       className='flex justify-center items-center font-bold text-h3 text-blue-500'>Findly
      </div>
    </div>
  );
}
